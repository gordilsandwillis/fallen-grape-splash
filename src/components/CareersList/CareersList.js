			...
			: (
				<Wrapper>
					<ScrollEntrance>
						...
						{departments && Object.values(departments).map(({ departmentName, jobs }) => (jobs && Object.keys(jobs).length > 0) && (
